...
namespace Common.Redis
{
    ...
    public static class RedisConnectionHelp
    {
        ...
        /// 系统自定义Key前缀
        /// </summary>
        public static readonly string SysCustomKey = ConfigurationManager.AppSettings["RedisKey"] ?? "sdn";

        /// <summary>
        /// 连接字符串
        /// </summary>
        private static readonly string RedisConnectionString = ConfigurationManager.AppSettings["RedisHosts"] ?? "50.79.98.190:6379,password=Star111";
